...
# MCU Chip
svg_content += draw_chip(90, 75, 100, 75, "DEV-0777", "Full Stack Core")

# Software / Memory Chip
svg_content += draw_chip(290, 40, 100, 50, "PYTHON // C++", "Backend Engine")

# Hardware / Frontend Chip
svg_content += draw_chip(290, 130, 100, 50, "WEB &amp; UI", "Frontend Dev")
